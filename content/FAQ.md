...
1. How does your device fingerprinting solution work? Is it a script I link to? Can I self-host it? 

A: TBD

1. What type of latency guarantees do you offer?
...
1. Does Dynamics 365 Fraud Protection provide a liability shift? 

A: TBD

1. How does this work with PSD2?

A: TBD

1. Do you provide reason codes or an explanation for a given risk assessment score?

A: TBD

1. How do you obtain quality fraud labels for model training?

A: TBD

1. Do I need to upload chargeback data to you? How do I do that?

A: TBD

1. I’m an existing Dynamics 365 customer. What type of integration is available to me out of the box?
...
1. What is your GDPR compliance story? Does this solution work in the EU?

A: TBD

1. How do you protect our data when we upload it? Do we need to hash everything before we upload it to you?
...
1. Do you collect, use, or disclose “sensitive personal data" (for example, race, ethnicity, political opinions, religious or other beliefs, etc.)?

A: TBD

1. I am an EU-based merchant. Will my customer’s data be shared outside of the EU? Where is this data hosted?

A: TBD

1. Will you directly seek consent from individuals to use their data in the context of fraud protection?

A: TBD

1. Why do you need to collect personal data?
...
1. Do you use tracking mechanisms (for example, cookies, pixels, etc.) to collect personal data?
...
1. How long do you retain collected personal data?
...
1. Can I delete personal data at any time while using Dynamics 365 Fraud Protection?
...
1. Do you provide independent periodic assurance reporting on the hosted environment, such as SOC 1/2 (AICPA), ISO 27001, Third-Party Trust, or other? 
...
1. Do you do frequently do vulnerability scans or penetration testing on the hosted environment? Is this report available periodically? 
...
1. Do you have a vulnerability disclosure policy?
...
1. What are your business continuity or disaster recovery practices?
...
1. Do you have monitoring, audit logging controls, or other facilities on user access?
...
1. Where can I find your terms and conditions or privacy statement?

A: See [Microsoft Licensing Terms](https://www.microsoft.com/en-us/licensing/product-licensing/products).

1. Where can I find your privacy statement?
