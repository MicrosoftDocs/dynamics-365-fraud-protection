...
| OrderInitiatedChannelMarket |string        |The market where the transaction was created (for example: App market).  |
| MerchantBusinessSubSegment   |string       |The second level business or industry segment.  |
