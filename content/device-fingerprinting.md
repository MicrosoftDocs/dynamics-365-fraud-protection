...
the purpose of using cookies for DFP is to collect information for a device, not for a particular individual. If you wish to opt out of using cookies you can, but it would degrade the device fingerprinting.
