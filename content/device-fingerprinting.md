...
|Experimental|Browser Language Anomaly|Browser languages aren't valid.|
|Experimental|Browser String Anomaly|Browser user agent is unknown.|
|Experimental|Browser String Mismatch|Browser user agent doesn't match script user agent.|
|Experimental|Device First Seen|Device first seen timestamp.|
|Experimental|Device Last Seen|Device last seen timestamp.|
|Experimental|Screen Aspect Ratio Anomaly|Screen aspect ratio isn't valid.|
|Experimental|Screen Resolution Anomaly|Screen resolution isn't valid.|
