...
> [!IMPORTANT]
> <p>Do not include the following sensitive personal data or highly regulated data types in the files that you upload:</p><p>- Biometric data, genetic data, or any data related to health.</p><p>- Personal data revealing racial or ethnic origin or religious views; or </p><p>- Personal data, which by their nature, are sensitive or private, such as data concerning a person’s sexual orientation or philosophical beliefs.</p><p>For information on how data is used and protected in Fraud Protection, see [Security, compliance, and data subject requests](security-compliance.md).</p>
