...
To edit entries in one or both sections, select the check boxes for them, and then select **Bulk list actions**. This screen lets you add or remove list assignments, select expiry dates, state your reason for the change, and add comments.
