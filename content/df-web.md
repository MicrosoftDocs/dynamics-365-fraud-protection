...
The DNS and SSL setup, while optional, is highly recommended. DNS and SSL setup allows for the fingerprinting script to be considered a first party integration, not a third party cookie.
