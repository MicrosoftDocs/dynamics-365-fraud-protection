...
Microsoft Dynamics 365 Fraud Protection gives you the flexability to create rules that leverage the score generated by DFP’s state of the art AI model, in conjuntion with any additional parameters from the request payload. Based on this inputs, rules can convert the assessment into a decision, such as *Approve*, *Reject*, *Review*, or *Challenge*.
