...
If your Fraud Protection instance has multiple environments, you can access **Risk support** in a specific environment by using the environment switcher. You can only search for the transactions in the same environment. 
