...
See [Set up and implement device fingerprinting](df-setup-overview.md) for more details on setting up and enabling device fingerprinting for web and mobile. [Attributes in device fingerprinting](df-attribute.md) details the device fingerprinting attribute fields Fraud Protection attempts to collect.
