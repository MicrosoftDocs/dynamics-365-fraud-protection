...
|Does the application / service have a recent third-party network security penetration test? (The test must be less than 3 months old.)  |Yes, Azure performs this periodically.             |
