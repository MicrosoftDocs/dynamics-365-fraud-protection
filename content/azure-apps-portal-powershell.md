...
Azure Active Directory (Azure AD) apps can be created within Microsoft Dynamics 365 Fraud Protection on the [Real-time APIs page](integrate-real-time-APIs.md). If you want to set them up directly in the Azure portal, follow these steps to create an Azure AD app registration. 
