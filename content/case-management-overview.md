...
> [1NOTE]
> The _Device fingerprinting_ template doesn't support case management. All other [Assessment templates](assessment-create-new.md#-select-template) support case management, except for the reporting capabilities.
