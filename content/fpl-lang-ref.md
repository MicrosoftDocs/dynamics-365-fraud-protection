...
| LET      | <p>Used to define a new variable. The scope of the variable is the rule or velocity set in which it is defined in. Variable names should be prefixed with $.</p><p>For more information, see [Define your own variables](fpl-lang-ref.md#define-your-own-variables). </p>  | LET $fullName = @”user.firstName” + @”user.lastName”  |
...
| $                 | Used to reference a variable which has been defined in a LET statement. For more information, see [Define your own variables](fpl-lang-ref.md#define-your-own-variables. | $fullName  |
