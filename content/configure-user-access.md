...
- You have one of these Fraud Protection roles assigned to you: **Product Admin**, **AllAreas_Admin** or **Manual Review Fraud Manager**. You will only be able to assign roles to other colleagues that have the same or lesser permissions than the role you have.
