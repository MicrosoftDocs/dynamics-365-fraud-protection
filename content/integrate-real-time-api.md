...
- **Purchase assessment APIs**: Purchase, PurchaseStatus, BankEvent, Chargeback, Refund, UpdateAccount, FraudLabel
- **Account creation assessment APIs**: SignUp, SignUpStatus, FraudLabel
