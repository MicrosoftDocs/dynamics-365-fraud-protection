...
|Historical Attributes|IP Address History|An array that contains IP address, TCP distance, and timestamp information for up to the last 5 sessions with the same cookie id.|
